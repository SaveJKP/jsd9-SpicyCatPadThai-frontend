  ...
  return (
    <div className ="min-h-screen  bg-(--color-background) text-(--color-text) pb-8">
      ...
      <section className ="py-8 px-16">
        <h1 className="font-bold text-5xl ">About <br></br> KatsuBook</h1> 
      ...
      <section>
        ...
        <div className="rounded-lg bg-(--color-banner) py-8 px-16 mb-8">
          <h2 className="font-bold text-2xl  "> Our services</h2>
          <h3 className="font-bold text-xl mt-8 mb-2">1.Read with us</h3>
          <p className="text-l">
            We gathered  manga, fantasy novels  with  heart-pounding stories conveniently available for purchase. </p>
