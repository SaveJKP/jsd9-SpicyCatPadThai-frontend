...
export default function OrderDetails() {
  ...
  return (
    <div className="container__div bg-[var(--color-text)] max-sm:rounded-t-2xl md:rounded-2xl">
      ...
      <div className="flex w-full justify-self-center sm:max-md:flex-col">
        <div className="w-[50%] flex-row sm:max-md:w-full">
        ...
        <div className="w-[50%] border border-[var(--color-radio)] p-[16px] sm:max-md:w-full">
